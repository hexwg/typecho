...
(function () {
    ...
    CORS_URL = '<?php echo Typecho_Common::url(__TYPECHO_PLUGIN_DIR__. '/UEditor/ueditor/', $options->siteUrl);?>';
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        serverUrl: "/usr/plugins/UEditor/ueditor/phpccccc/controller.php",
